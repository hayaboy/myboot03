		...
		<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<body>
				<table border=0 width="100%">
					...
					<tr>
						<td><a href="${contextPath}/main.do"> <img src="${contextPath}/image/rabbit.jpg" width="120"
									height="100" />
							</a></td>
						<td>
							<h3>
						...
						<td><a href="${contextPath}/member/loginForm1.do">
								<h3>로그인</h3>
							</a></td>
						</c:if>
						<c:if test="${isLogon==true}">
							<td><a href="${contextPath}/member/logout.do">
									<h3>로그아웃</h3>
								</a></td>
						</c:if>
						...
						<%-- <a href="${contextPath}/member/loginForm.do">
							...
							<%-- <c:choose>
								...
								<c:otherwise>
									<td><a href="${contextPath}/member/loginForm.do">
											<h3>로그인</h3>
										</a></td>
								</c:otherwise>
